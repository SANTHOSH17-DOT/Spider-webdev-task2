...
function spaceship(x, y) {
    ...
    this.shipW4 = (boss4) => {
        ...
        shipT = this.y - 70 / 2;
        shipB = this.y + 70 / 2;
        boss4B = boss4.y + 130 / boss4.scale;
        boss4T = boss4.y - 130 / boss4.scale;
        boss4R = boss4.x + 130 / boss4.scale;
        boss4L = boss4.x - 130 / boss4.scale;
...
function updateGame() {
    ...
    if (gameover == false) {
        ...
        for (i = 0; i < aliens.length; i++) {
            if (aliens[i].type == 1) {
                ...
                if (spacer.shipW1(aliens[i]) == true) {
                    gameover = true;
                    break;
                }
            } else if (aliens[i].type == 3) {
                if (spacer.shipW2(aliens[i]) == true) {
                    gameover = true;
                    break;
                }
            } else if (aliens[i].type == 4) {
                if (spacer.shipW3(aliens[i]) == true) {
                    gameover = true;
                    break;
                }
            } else if (aliens[i].type == 5) {
                if (spacer.shipW4(aliens[i]) == true) {
                    gameover = true;
                    break;
                }
            }
    ...
    if (gameover) {
        ...
        if (level == 5) {
            ...
            gameArea.context.fillText(`BONUS LEVEL`, 20, 30);
        } else {
        ...
        if (gameArea.frameNo % 125 == 0) {
            ...
            if (level == 1) {
                ...
                if (bossSelect == 0) {
                    aliens.push(new boss1(800 + 100 * (i - 1), decision * 400 / (alienPos + 1), Math.floor(Math.random() * 2), 1.5));
                } else if (bossSelect == 1) {
                    aliens.push(new boss2(800 + 100 * (i - 1), decision * 400 / (alienPos + 1), Math.floor(Math.random() * 2), 1.5));

                } else if (bossSelect == 2) {
                    aliens.push(new boss3(800 + 100 * (i - 1), decision * 400 / (alienPos + 1), Math.floor(Math.random() * 2), 2));

                } else if (bossSelect == 3) {
                    aliens.push(new boss4(800 + 100 * (i - 1), decision * 400 / (alienPos + 1), Math.floor(Math.random() * 2), 2));

                } else if (bossSelect == 4) {
                    aliens.push(new boss5(800 + 100 * (i - 1), decision * 400 / (alienPos + 1), Math.floor(Math.random() * 2), 3));
                }
            }
